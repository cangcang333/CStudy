/*************************************************************************
	> File Name: event_dns_server.c
	> Author: 
	> Mail: 
	> Created Time: Sat Jun 23 14:59:35 2018
 ************************************************************************/
 ...
 * operating systems it requires root priviledges. */
#define LISTEN_PORT 53535
...
void server_callback(struct evdns_server_request * request, void *data)
{
    ...
    * questions in one request yourself. */
    for (i = 0; i < request->nquestions; ++i)
    {
        ...
        int ok = 1;
        /* we don't use reqular strcasecmp here, since we want a locale-independent comparison. */
